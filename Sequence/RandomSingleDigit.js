//1.random number between 1 to 10
var value1 = (Math.floor(Math.random() * 10))
console.log(value1);
//2. random number between 1 to 6
...
console.log(result);
//4. sum and average of two digit random numbers
var sum = 0;
for(var i=1; i<=5; i++){
...
//5.a.- conversion of inches to feet
...
//5.b. -conversion of feet into meters
...
//5.c.conversion of 25 plots in acres
